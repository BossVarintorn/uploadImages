let githubUser = 'bossvarintorn'
let repo = 'uploadImages'
...
async function login() {
    ...
    const response = await fetch('https://script.google.com/macros/s/AKfycbzmRr2pUYS9fgltH8fIXFK59r3b5SCjmOMWo1mYIev9o8YyFjL2m0lBmqCtfW3LivpI/exec');
